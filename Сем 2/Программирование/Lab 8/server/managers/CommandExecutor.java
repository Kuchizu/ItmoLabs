    ...
    public void run() throws IOException {
        ...
        while (true) {
            ...
            try {
                ...
                InetSocketAddress newConnected = new InetSocketAddress(cmdPacket.getAddress(), cmdPacket.getPort());
                connectedUsers.add(newConnected);
                ...
                ForkJoinPool.commonPool().submit(() -> {
                    ...
                    System.out.printf("[%s][%s]: Got message:\n%s\n", inetAddress, port, finalInf);
