...
def not_mine():
    ...
    json2xml.Json2xml(readfromjson('schedule.json')).to_xml()


print(
    'Мой код: ', timeit('my()', setup="from __main__ import my", number=1000)
)
print(
    'С регулярками: ', timeit('reg_mine()', setup="from __main__ import reg_mine", number=1000)
)
print(
    'Библиотека: ', timeit('not_mine()', setup="from __main__ import not_mine", number=1000)
)